...
/// Import the transaction payment pallet.
	...
	AccountIdOf<R>: From<AccountId> + Into<AccountId>,
{
	fn handle_credit(credit: CreditOf<AccountIdOf<R>, pallet_assets::Pallet<R>>) {
		...
		let ferdie = [
			28, 189, 45, 67, 83, 10, 68, 112, 90, 208, 136, 175, 49, 62, 24, 248, 11, 83, 239, 22,
			179, 97, 119, 205, 75, 119, 184, 70, 242, 165, 240, 124,
		];
...
impl_runtime_apis! {
	...
	// LS: Transaction payment runtime API simply forwards calls to implementation within pallet
	...
	// LS: Transaction payment call runtime API simply forwards calls to implementation within pallet
