...
// Configure the pallet-chainlink in pallets/chainlink.
parameter_types! {
...
impl pallet_chainlink_feed::Config for Runtime {
	...
	type WeightInfo = pallet_chainlink_feed::weights::SubstrateWeight<Runtime>;
...
impl pallet_chainlink::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type Currency = Balances;
	type Callback = pallet_example::Call<Runtime>;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Sudo: pallet_sudo,
		// Include the custom logic from the pallet-chainlink in the runtime.
